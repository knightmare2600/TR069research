...
# v1.2 - 21.11.2011 Morten Simonsen
...
if [ ! -e startssl_sub.class1.server.ca.pem ]
then
	echo "Missing file 'startssl_sub.class1.server.ca.pem', this file must" 
...
cat ${HOST}.crt startssl_sub.class1.server.ca.pem startssl_ca.pem > ${HOST}.chn &&
